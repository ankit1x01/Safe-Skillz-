...
export const Work = () => {
  ...
  return (
    <div>
      ...
      <section className="relative py-16 lg:py-20 overflow-hidden bg-gradient-to-bl from-accent via-primary to-primary-dark">
          ...
          <div className="mt-16 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-600 mb-8">
                From Fortune 500 companies to government agencies and leading universities, SafeSkillz parent company CSI has delivered impactful cybersecurity training across diverse sectors.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Public Sector Agencies</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-2">Academic</div>
                  <div className="text-sm text-gray-600">Universities & Colleges</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-2">Conferences</div>
                  <div className="text-sm text-gray-600">Industry Events</div>
                </div>
              </div>
            </div>
          </div>
